...
public class RentACatIntegrationTest {
	...
	PrintStream outContent; // Print stream for testing system out
	...
	public void setUp() throws Exception {
		...
		outContent = new PrintStream(out);
	...
	public void testRenameFailureNumCats0() {
		// TODO: Fill in
		boolean val = r.renameCat(2, "Garfield");
		assertFalse(val);
